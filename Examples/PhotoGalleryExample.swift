...
struct Photo: GridNavigable {
    ...
    static let samplePhotos: [Photo] = [
        Photo(
            ...
            tags: ["landscape", "bridge", "architecture"],
            isFavorite: true,
            colorTheme: .orange,
        ),
        Photo(
            ...
            dateCreated: Date().addingTimeInterval(-86400 * 28),
        ...
        Photo(
            ...
            dateCreated: Date().addingTimeInterval(-86400 * 25),
        ...
        Photo(
            ...
            title: "Beach Sunset",
            location: "Malibu, CA",
            dateCreated: Date().addingTimeInterval(-86400 * 22),
            size: CGSize(width: 4032, height: 3024),
        ...
        Photo(
            ...
            dateCreated: Date().addingTimeInterval(-86400 * 20),
            size: CGSize(width: 3024, height: 4032),
        ...
        Photo(
            ...
            dateCreated: Date().addingTimeInterval(-86400 * 18),
            size: CGSize(width: 4032, height: 3024),
            tags: ["desert", "landscape", "rocks"],
            isFavorite: false,
            colorTheme: .brown,
        ),
        Photo(
        ...
        Photo(
            ...
            title: "Flower Garden",
            location: "Butchart Gardens, BC",
            dateCreated: Date().addingTimeInterval(-86400 * 10),
            size: CGSize(width: 4032, height: 3024),
            tags: ["flowers", "garden", "nature"],
            isFavorite: true,
            colorTheme: .pink,
        ),
        Photo(
...
struct PhotoGalleryExample: View {
    ...
    private var filteredAndSortedPhotos: [Photo] {
        ...
        if !searchText.isEmpty {
            filtered = filtered.filter { photo in
                photo.filename.localizedCaseInsensitiveContains(searchText)
                    ...
                    || photo.location?.localizedCaseInsensitiveContains(
                        searchText,
                    ) == true
                    || photo.tags.contains {
        ...
        return filtered.sorted { photo1, photo2 in
            switch sortBy {
            case .dateCreated:
                photo1.dateCreated > photo2.dateCreated
            case .filename:
                photo1.filename < photo2.filename
            case .title:
                photo1.title < photo2.title
            case .fileSize:
                (photo1.size.width * photo1.size.height)
                    > (photo2.size.width * photo2.size.height)
            }
        }
    }
                ...
                VStack(spacing: 12) {
                    ...
                    HStack {
                        ...
                        Button {
                            ...
                            .font(.caption)
                            .foregroundStyle(
                                showFavoritesOnly ? .red : .secondary,
                            )
                        }
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        PhotoDetailRow(
                            icon: "calendar",
                            title: "Date Created",
                            value: photo.dateCreated.formatted(
                                date: .complete,
                                time: .shortened,
                            ),
                        )
                        PhotoDetailRow(
                            icon: "rectangle",
                            title: "Dimensions",
                            value: photo.sizeText,
                        )
                        PhotoDetailRow(
                            icon: "doc",
                            title: "File Size",
                            value: photo.fileSizeText,
                        )
                        PhotoDetailRow(
                            icon: "textformat",
                            title: "Filename",
