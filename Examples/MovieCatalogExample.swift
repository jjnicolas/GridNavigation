...
struct Movie: GridNavigable {
    ...
    static let sampleMovies: [Movie] = [
        ...
        Movie(
            ...
            duration: 148,
            description:
            "A thief enters people's dreams to steal secrets but must plant an idea instead.",
            posterColor: .blue,
            isWatchLater: true,
        ),
        Movie(
            ...
            duration: 169,
            description:
            "Explorers travel through a wormhole to save humanity from Earth's declining environment.",
            posterColor: .orange,
            isWatchLater: false,
        ),
        Movie(
        ...
        Movie(
            ...
            duration: 154,
            description:
            "Interconnected stories of Los Angeles criminals, including two hit men and a boxer.",
            posterColor: .yellow,
            isWatchLater: true,
        ),
        Movie(
        ...
        Movie(
            ...
            duration: 146,
            description:
            "The story of Henry Hill's life in the mob from childhood to adulthood.",
            posterColor: .brown,
            isWatchLater: false,
        ),
        Movie(
        ...
        Movie(
            ...
            duration: 175,
            description:
            "The aging patriarch transfers control of his empire to his reluctant son.",
            posterColor: .indigo,
            isWatchLater: false,
        ),
        Movie(
            ...
            duration: 195,
            description:
            "The story of how one man saved over a thousand Jewish lives during the Holocaust.",
            posterColor: .gray,
            isWatchLater: true,
        ),
        Movie(
            ...
            duration: 147,
            description:
            "A U.S. Army officer is sent to assassinate a colonel gone rogue in Vietnam.",
            posterColor: .green,
            isWatchLater: false,
        ),
    ]
...
struct MovieCatalogExample: View {
    ...
    private let genres = [
        "All", "Action", "Crime", "Drama", "Sci-Fi", "Thriller", "War",
    ]
        ...
        if !searchText.isEmpty {
            filtered = filtered.filter { movie in
                movie.title.localizedCaseInsensitiveContains(searchText)
                    || movie.director.localizedCaseInsensitiveContains(
                        searchText,
                    )
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        HStack {
                            ...
                            Button(action: onWatchLaterToggle) {
                                ...
                                .font(.subheadline)
                                .foregroundStyle(
                                    movie.isWatchLater ? .blue : .primary,
                                )
